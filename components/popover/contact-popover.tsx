                ...
                >
                    {socialLinks.map((link) => (
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="flex flex-col items-center gap-2 p-3 rounded-lg bg-white/5 border border-white/10 transition-colors duration-200 group"
                        >
                            <span className="text-white/70 group-hover:text-white transition-colors duration-200">
                                {link.icon}
                            </span>
                            <span className="text-xs text-white/60 group-hover:text-white/80 font-light">
                                {link.name}
                            </span>
                        </motion.a>
                    ))}
